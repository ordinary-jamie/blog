            ...
            <div class="p-2 rounded -mx-2 hover:ring-sky-500 hover:bg-sky-50 group">
                <div class="flex flex-nowrap">
                    <div class="flex items-end">
                        <span class="font-mono text-sm text-slate-500 group-hover:text-sky-500 pb-1">@{{
                            section
                        }}/</span>
                ...
                <div class="flex text-slate-400 font-thin text-sm group-hover:text-slate-800 pl-1 items-center">
                    <slot />&thinsp;
